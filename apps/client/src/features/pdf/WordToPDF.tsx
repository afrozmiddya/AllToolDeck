...
import { FileDown, Construction } from "lucide-react";
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Convert Microsoft Word documents (.docx) into PDF format.</CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="flex flex-col items-center justify-center p-12 border border-zinc-200 dark:border-zinc-800 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-500 mt-2 max-w-md mx-auto">
                Word to PDF conversion is highly complex and requires native rendering engines. We are actively working on a robust backend solution for this tool.
              </p>
            </div>
