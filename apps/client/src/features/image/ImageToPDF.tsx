  ...
  const handleConvertToPDF = async () => {
    ...
    try {
      ...
      if (file.type === 'image/jpeg' || file.type === 'image/jpg') {
        ...
        throw new Error("Only JPEG and PNG images are supported for direct PDF conversion.");
      }
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Instantly convert a PNG or JPEG image into a PDF document.</CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          {!downloadUrl ? (
            <>
              <FileDropZone 
                ...
                description="Drag and drop your image here (PNG or JPEG only)"
                maxSizeMB={25}
              />
